                            ...
                            <ul class="nav navbar-nav">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-fw">
                                        ...
                                        <li class="active">
                                            <a href="dashboard_2.html">
                                                <i class="icon-bulb"></i> Dashboard</a>
                                        </li>
                                ...
                                <li class="dropdown dropdown-fw dropdown-fw-disabled  ">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-fw">
                                        ...
                                        <li>
                                            <a href="table_static_responsive.html"> Responsive
                                                Tables </a>
                                        </li>
                                        <li>
                                        ...
                                        <li class="dropdown more-dropdown-sub">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="table_datatables_managed.html"> Managed
                                                        Datatables </a>
                                                </li>
                                                <li>
                                                    <a href="table_datatables_buttons.html"> Buttons
                                                        Extension </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="table_datatables_scroller.html"> Scroller
                                                        Extension </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="table_datatables_editable.html"> Editable
                                                        Datatables </a>
                                                </li>
                                                <li>
                                                    <a href="table_datatables_ajax.html"> Ajax
                                                        Datatables </a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title tabbable-line">
                                    <div class="caption">
                                        ...
                                        <span
                                            class="caption-subject font-dark bold uppercase">Comments</span>
                                    </div>
                                    <ul class="nav nav-tabs">
                                        <li class="active">
                                            <a href="#portlet_comments_1" data-toggle="tab">
                                                Pending </a>
                                        </li>
                                        <li>
                                            <a href="#portlet_comments_2" data-toggle="tab">
                                                Approved </a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="mt-comments">
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img">
                                                        <img
                                                            src="../assets/pages/media/users/avatar1.jpg"/>
                                                    </div>
                                                    <div class="mt-comment-body">
                                                        ...
                                                        <div class="mt-comment-text"> Lorem Ipsum is
                                                ...
                                                <div class="mt-comment">
                                                    ...
                                                    <div class="mt-comment-body">
                                                        <div class="mt-comment-info">
                                                                            <span
                                                                                class="mt-comment-author">Natasha Kim</span>
                                                            <span class="mt-comment-date">19 Dec,09:50 AM</span>
                                                        </div>
                                                        <div class="mt-comment-text"> The generated
                                                            Lorem or non-characteristic Ipsum is
                                                ...
                                                <div class="mt-comment">
                                                    ...
                                                    <div class="mt-comment-body">
                                                        ...
                                                        <div class="mt-comment-text"> The standard chunk
                                                            of Lorem or non-characteristic Ipsum used
                                                            since the 1500s or non-characteristic.
                                                        </div>
                                                        <div class="mt-comment-details">
                                                                            <span
                                                                                class="mt-comment-status mt-comment-status-rejected">Rejected</span>
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title tabbable-line">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li>
                                            <a href="#tab_actions_completed" data-toggle="tab">
                                                Completed </a>
                                        </li>
                                    </ul>
                                </div>
                                            ...
                                            <div class="mt-actions">
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img
                                                            src="../assets/pages/media/users/avatar10.jpg"/>
                                                    </div>
                                                        ...
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                ...
                                                                <div class="mt-action-details ">
                                                                    ...
                                                                    <p class="mt-action-desc">Dummy text
                                                                        of the printing</p>
                                                                </div>
                                                            </div>
                                                            <div class="mt-action-datetime ">
                                                                                <span
                                                                                    class="mt-action-date">3 jun</span>
                                                                <span
                                                                    class="mt-action-dot bg-green"></span>
                                                                <span
                                                                    class="mt=action-time">9:30-13:00</span>
                                                            </div>
                                                        ...
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                ...
                                                                <div class="mt-action-details ">
                                                                    ...
                                                                    <p class="mt-action-desc">pending
                                                                        for approval</p>
                                                                </div>
                                                            </div>
                                                            <div class="mt-action-datetime ">
                                                                                <span
                                                                                    class="mt-action-date">3 jun</span>
                                                                <span
                                                                    class="mt-action-dot bg-red"></span>
                                                                <span
                                                                    class="mt=action-time">9:30-13:00</span>
                                                            </div>
                                                            <div class="mt-action-buttons ">
                                                        ...
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                ...
                                                                <div class="mt-action-details ">
                                                                    ...
                                                                    <p class="mt-action-desc">Text of
                                                    ...
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                ...
                                                                <div class="mt-action-details ">
                                                                    <span
                                                                        class="mt-action-author">Donna Clarkson </span>
                                                                    <p class="mt-action-desc">Simply
