                                        ...
                                        <div class="portlet light portlet-fit bordered">
                                            <div class="portlet-title">
                                                <div class="caption">
                                                    ...
                                                    <span class="caption-subject font-red sbold uppercase">Intro Table</span>
                                                </div>
                                            </div>
                                            <div class="portlet-body">
                                                <div class="table-toolbar">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="btn-group">
                                                                <a href="{{url('/admin/intros/add')}}"> Add New
                                                ...
                                                <table class="table table-striped table-hover table-bordered" id="sample_editable_1" style="color: #0c0c0c">
                                                    ...
                                                    @foreach($intro as $in)
                                                        <tr>
                                                            ...
                                                            <td> {{$in['bio']}} </td>
                                                            <td>
                                                                <a  style="color: green" href="{{url('/admin/intros/edit/'.$in['id'])}}"> Edit </a>
                                                            </td>
                                                            <td>
