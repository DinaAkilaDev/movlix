                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="portlet box yellow">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-gift"></i>Edit View
                                </div>
                            </div>
                            <div class="portlet-body form">
                                <form action="{{route('editreview')}}" method="post" class="form-horizontal">
                                    @csrf
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="user_id" value="{{$reviews->user_id}}" class="form-control"
                                                           placeholder="user_id">
                                                    <input type="hidden" name="id" value="{{$reviews->id}}"  required>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="comment" value="{{$reviews->comment}}" class="form-control"
                                                           placeholder="comment">
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="movie_id" value="{{$reviews->movie_id}}" class="form-control"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" name="review_id" value="{{$reviews->review_id}}" class="form-control"
