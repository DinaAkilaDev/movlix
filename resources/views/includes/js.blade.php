...
<script src="{{ URL::to('../assets/layouts/layout5/scripts/layout.min.js') }}" type="text/javascript"></script>
...
<script src="{{ URL::to('../assets/global/scripts/app.min.') }}" type="text/javascript"></script>
